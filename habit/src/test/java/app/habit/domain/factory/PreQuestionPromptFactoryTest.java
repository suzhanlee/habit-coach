...
class PreQuestionPromptFactoryTest {

    @Test
    @DisplayName("gpt에게 보낼 사용자의 습관 형성 단계 평가를 위한 프롬프트 dto를 생성한다.")
    void create_request_prompt() {
        // given
        PreQuestionPromptFactory factory = new PreQuestionPromptFactory();

        // when
        RequestPrompt result = factory.create();
    ...
    private RequestPrompt createExpected() {
        ...
        return new RequestPrompt("gpt-3.5-turbo-0125", List.of(new PromptMessage(PromptRole.USER, prompt)));
    }
}
