...
//        FeedbackModule feedbackModule = new FeedbackModule("주제1", List.of(
//                new FeedbackSession("1", "질문1", "대답1"),
//                new FeedbackSession("2", "질문2", "대답2"),
//                new FeedbackSession("3", "질문3", "대답3")
//                ));
//        String givenHabitFormingPhaseType = "Consideration stage";
//
//        // when
//        RequestPrompt result = factory.create(feedbackModule, givenHabitFormingPhaseType);
//
//        // then
