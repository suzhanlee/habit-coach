...
public class PhaseCoach {

    private static final String apiKey = "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";

    private final RestTemplate restTemplate;

    public List<UserHabitPreQuestionRs> advice(RequestPrompt requestBody, String url) {
    ...
    private List<UserHabitPreQuestionRs> getCoreAdvice(GptRsWrapper body) {
